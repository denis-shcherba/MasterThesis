...
floatPhi (floatZ){ joint:hingeZ, limits:[-1, 1], mass:.01 }

Include <$RAI_PATH/panda/panda_gripper.g>

gripper_base(floatPhi): { Q:"t(0 0 .1035) d(180 1 0 0) d(-90 0 0 1)", shape: marker, size: [.03] }
