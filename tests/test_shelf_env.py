...
def main(cfg: DictConfig):
    ...
    env = gym.make("ShelfEnv-v1", img_type="DEPTH", robot_mode=cfg.robot_mode, end_effector=None, path_mode="pos3d", shelf_pos_xyz=cfg.shelf_pos_xyz, shelf_quaternion=cfg.shelf_quaternion, shelf_floor_offsets=cfg.shelf_floor_offsets, camera_name=cfg.camera_name, simulate=True, seed=42, collect_data=False, box_size_ranges=cfg.box_size_ranges, allow_book_yaw=cfg.allow_book_yaw,  focal_length_range=cfg.focal_length_range)
